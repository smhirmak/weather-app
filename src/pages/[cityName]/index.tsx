...
const CityPage: React.FC<{ cityWeatherResponse: IWeather; isRouteLoading: boolean }> = ({
  cityWeatherResponse,
  isRouteLoading
}) => {
  ...
  return (
    <Container sx={{ opacity: isRouteLoading ? 0.4 : 1 }}>
      <Head>
        <title>Weather App - {cityName.replace(' Province', '')}</title>
